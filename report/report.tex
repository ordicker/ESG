...
%\vskip 0.2in
%\begin{center}
%\centerline{\includegraphics[width=\columnwidth]{images/polyfit_test.svg}}
%\caption{}
%\end{center}
%\vskip -0.2in
%\end{figure}
...
%\vskip 0.2in
%\begin{center}
%\centerline{\includegraphics[width=\columnwidth]{images/polyfit_train.svg}}
%\caption{}
%\end{center}
%\vskip -0.2in
%\end{figure}
...
%\vskip 0.2in
%\begin{center}
%\centerline{\includegraphics[width=\columnwidth]{images/MNIST_test.svg}}
%\caption{}
%\end{center}
%\vskip -0.2in
%\end{figure}
...
%\vskip 0.2in
%\begin{center}
%\centerline{\includegraphics[width=\columnwidth]{images/MNIST_train.svg}}
%\caption{}
%\end{center}
%\vskip -0.2in
%\end{figure}
...
%\vskip 0.2in
%\begin{center}
%\centerline{\includegraphics[width=\columnwidth]{images/CIFAR_test.svg}}
%\caption{}
%\end{center}
%\vskip -0.2in
%\end{figure}
...
\vskip 0.2in
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{images/Fashion_test.png}}
\caption{}
\end{center}
\vskip -0.2in
\end{figure}
